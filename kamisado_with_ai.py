...
class Kamisado(TwoPlayerGame):
    ...
    def possible_moves(self):
        ...
        # make strait, left diagonal, right diagonal moves
        
        # when tower is blocked, append current location
        # Because the rule is that you have to click on your own tower to pass
